...
=> key의 조건?
   - 같은 값을 갖는 인스턴스는 
     ...
     equals()의 리턴 값도 true여야 한다.
=> 데이터 조회
   - key를 가지고 데이터를 찾는다.
=> HashMap vs Hashtable
1) null 허용 여부
   - HasnMap은 key 또는 value에 null값을 넣을 수 있다.
   - Hashtable은 key 또는 value에 null값을 넣을 수 없다.
...
public class Exam091_0 {
  public static void main(String[] args) {
    ...
    //=> key 객체의 저장된 값이 같다면 해시값도 같아야 한다.
    //   hashCode()와 equals()를 재정의한 클래스만 사용하라.
    //   예) String, Wrapper클래스(Byte, Short, Integer, Long, Float, Double, Character)
    map.put("s001", "홍길동");
    map.put("s002", "임꺽정");
    map.put("s003", "유관순");
    map.put("s004", "안중근");
